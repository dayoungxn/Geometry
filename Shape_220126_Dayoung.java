...
public class Shape_220126_Dayoung
{
   //instance variables
	private int xPos;
	private int yPos;
   ...
   */
   public Shape_220126_Dayoung(int x, int y, int wid, int ht, Color col, int xSpd, int ySpd)
   {
		xPos = x;
   ...
   public void draw(Graphics window)
   {
      ...
      //i drew a circle :D
     window.drawArc(xPos, yPos, width, height, width, height);
